...
const Sheets = () => {
  ...
  return (
    <div className='  overflow-y-auto bg-gradient-to-b pt-8 max-sm:mt-16 shadow-none from-slate-900 via-zinc-950 to-slate-900 h-full w-full p-36 scrollbar-hidden '>

      <h2 className="text-2xl  z-30 max-sm:text-md max-sm:m-4 rounded-2xl text-white text-center max-w-2xl m-9 ml-[9rem]"> DSA Sheet For Everyone </h2>
