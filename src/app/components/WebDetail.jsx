...
const CourseDetail = () => {
  ...
  const [includeNextJS, setIncludeNextJS] = useState(false);
    ...
    const fetchCourseData = () => {
      setTimeout(() => {
        setCourse({
          ...
          description: "Master full stack web development with MongoDB, Express, React, and Node.js. Build modern web applications from scratch and deploy them to production.",
          topics: [
          ...
          discountPrice: 5999,
          nextJSPrice: 1000,
          videoUrl: "https://www.youtube.com/embed/7CqJlxBYj-M?si=6O4w9V4XfQJ7Y9Qa"
        });
        setLoading(false);
      }, 500);
    };
...
const handleSubmit = async (e) => {
  ...
  const totalPrice = includeNextJS 
    ? course.discountPrice + course.nextJSPrice 
          ...
          >              
            ...
            >
              <div className="inline-block bg-indigo-800/30 backdrop-blur-sm px-4 py-2 rounded-full mb-6 border border-indigo-600">
                <span className="text-indigo-300 text-sm font-medium">Most Popular</span>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="flex items-center bg-indigo-800/40 px-4 py-2 rounded-full backdrop-blur-sm">
                <FaCode className="text-indigo-300 mr-2" />
          ...
          <div className="lg:col-span-1">
            ...
            >
              <div className="flex items-center justify-between mb-4">
                ...
                >
                  <FaStar className="mr-1" /> 4.9 (2.5k reviews)
                </motion.div>
              </div>
              ...
              >
                <div 
                  className={`p-4 rounded-lg border ${includeNextJS ? 'border-purple-500 bg-purple-900/20' : 'border-gray-700 bg-gray-700/30'} transition-all cursor-pointer`}
                  onClick={() => setIncludeNextJS(!includeNextJS)}
                >
                  <div className="flex items-center">
                    <motion.div
                      animate={{ 
                        scale: includeNextJS ? 1.1 : 1,
                        backgroundColor: includeNextJS ? '#8B5CF6' : '#374151'
                      }}
                      className={`w-5 h-5 rounded-md border ${includeNextJS ? 'border-purple-500' : 'border-gray-600'} flex items-center justify-center mr-3 transition-all`}
                    >
                      {includeNextJS && (
                        <motion.svg
                          initial={{ scale: 0 }}
                    ...
                    <div className="flex-1">
                      <div className="flex justify-between items-center">
                        <h4 className="font-medium">Add Next.js (Advanced React Framework)</h4>
                        <span className="text-purple-400 font-bold">+₹{course.nextJSPrice}</span>
                      </div>
                      <p className="text-sm text-gray-400 mt-1">
                        Learn server-side rendering, static site generation, and API routes
                      </p>
                    </div>
                  </div>
                </div>
                ...
                {includeNextJS && (
                  ...
                  >
                    ...
                    <div className="flex justify-between pt-1">
                      <span>Next.js Add-on</span>
                      <span>₹{course.nextJSPrice}</span>
                    </div>
                  </motion.div>
                )}
              </motion.div>
                ...
                >
                  <div className="p-6">
                    ...
                    <p className="text-gray-400 text-center mb-6">
                      Scan the QR code or use the UPI IDs below to pay ₹{totalPrice}
                    </p>
                    ...
                    >
                      <Image
  src="/QR-payment.jpg"  // Direct path from public folder
