...
const DSA = () => {
  ...
  const course = {
    ...
    includes: [
      ...
      { icon: <FaCode className="text-green-400" />, text: "100+ Problems" },
      { icon: <FaLaptopCode className="text-purple-400" />, text: "Projects" },
  ...
  return (
    <motion.div 
      ...
      className="max-w-md  w-[30rem] mx-auto rounded-xl overflow-hidden bg-gray-900 border border-gray-800 shadow-lg"
    >
      {/* Course Header */}
      ...
      <div className="p-5">
        ...
        {/* CTA Button */}
        <button 
         onClick={() => router.push("/dsa-details")}
